...
uniform LightSpot lightSpot1;
uniform LightSpot lightSpot2;
...
void main()
{
    ...
    finalResult += CalcLightSpot(lightSpot1, uNormal, dirToCamera);
    finalResult += CalcLightSpot(lightSpot2, uNormal, dirToCamera);
